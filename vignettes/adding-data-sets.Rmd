...
`region_level_2`
 : Name of level 2 region

`level_2_region_code`
 : Code for level 2 region

`region_level_1`
 : Name of level 1 region
...
`country`
 :   The country name as a character string, all lower-case letters.
