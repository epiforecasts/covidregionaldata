...
We can dig down further and get county information (a political subdivision of a state) by using the `include_level_2_regions = TRUE` argument to the function:
