...
`covidregionaldata` provides an interface to subnational and national level COVID-19 data sourced from both official sources, such as Public Health England (UK), and from other Covid-19 data collections, such as WHO and Google Open Data. For all countries supported, this includes a daily time-series of cases. Wherever available we also provide data on deaths, hospitalisations, and tests. National level data is also supported using a range of data sources as well as line list data and links to intervention data sets. Data is cleaned and processed from the raw sources on use in an open and transparent way, allowing users to scrutinise and extend our methods.
