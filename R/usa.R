...
#' @return A data frame of daily COVID cases for the US by state, to be further processed by \code{get_regional_covid_data()}.
...
#' It is loaded and then sanitised.
#' @return A data frame of daily COVID cases for the US by county, to be further processed by \code{get_regional_covid_data()}.
