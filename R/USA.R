...
USA <- R6::R6Class("USA",
  ...
  public = list(
    ...
    data_url_level_1 = list(
      "main" = "https://raw.githubusercontent.com/nytimes/covid-19-data/master/us-states.csv" # nolint
    ),
    #' @field data_url_level_2 link to raw data for level 2
    data_url_level_2 = list(
      "main" = "https://raw.githubusercontent.com/nytimes/covid-19-data/master/us-counties.csv" # nolint
    ),
    ...
    set_region_codes = function() {
      self$codes_lookup$`1` <- usa_codes <- tibble::tibble(
