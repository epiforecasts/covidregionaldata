#' Brazil regional cases and deaths stratifying by Admin Level 1 region (state)

#' @description Extracts regional case and death counts for Brazil, stratified by state.
...
#' Brazil regional cases and deaths stratiftinf by Admin Level 2 region (city)

#' @description Extracts regional case and death counts for Brazil, stratified by city
#' Data available on Github, curated by Wesley Cota: DOI 10.1590/SciELOPreprints.362
#' [Source](https://github.com/wcota/covid19br)
#' @importFrom dplyr %>% mutate filter select left_join group_by summarise recode
#' @importFrom lubridate ymd
#'
