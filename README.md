...
``` r
start_using_memoise()
#> Using a cache at: /tmp/RtmpdTom4d
```
...
#> # … with 6,152 more rows, and 9 more variables: newCasesBySpecimenDate <dbl>, cumDeaths28DaysByDeathDate <dbl>, cumDeaths28DaysByPublishDate <dbl>, newDeaths28DaysByDeathDate <dbl>, newDeaths28DaysByPublishDate <dbl>,
