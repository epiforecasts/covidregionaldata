# Code to construct a CSV of region codes for France
...
combined_region_codes <- left_join(france_level_2_codes,
                                   france_level_1_codes%>%select(-region_level_1),
                                   by=c("level_1_region_code"="iso_code"))

write_csv(combined_region_codes, "data-raw/france_codes.csv")